...
import { navigationSections, sectionForPath } from "@/app-navigation";
...
import { SideWorkbench } from "@/components/shell/SideWorkbench";
      ...
      <div className="min-w-0 flex-1">
        {isConversation ? (
          ...
          <div className="min-w-0">
            <p className="font-mono text-[9px] uppercase tracking-[0.18em] text-[#6f7169]">
              {surfaceLabel}
            </p>
...
export function WorkspaceShell() {
  ...
  // Eyebrow above the assistant name. Previously hardcoded to "Agent", which
  // was wrong on every surface except Chat.
  const surfaceLabel =
    navigationSections.find((section) => section.id === sectionForPath(location.pathname))?.label ??
    "ARES";
      ...
      >
        {isCompact ? (
          <div className="relative flex h-full min-h-0 flex-col">
            ...
            {/* Left drawer: SessionSidebar (sessions + modes) */}
            <div
              id="ares-mobile-deck"
            ...
            >
              ...
              <div className="min-h-0 flex-1">
                <SessionSidebar onNavigate={closeDeck} onSessionOpened={closeDeck} />
              </div>
            </div>
            ...
            >
              <SideWorkbench onCollapse={collapseWorkbench} />
            </div>
          </div>
        ) : (
          <>
