        ...
        <div className="grid gap-6">
          ...
          <Card>
            ...
            <CardContent className="grid gap-3">
              ...
              <Button asChild variant="outline" size="sm" className="w-fit">
                <Link to="/telemetry?tab=automations&view=pairing">Manage paired devices</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-2">
              ...
              <Button asChild variant="outline" size="sm">
                <Link to="/telemetry?tab=security&view=secrets">Secrets</Link>
              </Button>
              <Button asChild variant="outline" size="sm">
                <Link to="/telemetry?tab=security&view=memory">Memory & Privacy</Link>
              </Button>
            </CardContent>
          </Card>
