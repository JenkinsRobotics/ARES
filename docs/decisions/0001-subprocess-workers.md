...
> **Superseded by [ADR-0008](./0008-worker-access-and-the-vestigial-gateway.md).**
> The substance holds — workers stay out-of-process — but "subprocesses" is
> too narrow: ARES also reaches workers via vendor SDKs over HTTPS and local
> HTTP. Retained unedited as history.
