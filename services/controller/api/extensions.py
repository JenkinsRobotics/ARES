...
_CURATED_EXTENSION_ENTRIES: list[dict[str, Any]] = [
    {
        "id": "ares-themes-pack",
    ...
    {
        "id": "mascot-companion",
        "name": "Animated Pet Mascot Companion",
        "version": "2.1.0",
        "description": "Interactive companion sprite mascots with Codex & Petdex animation loops (idle, wave, run, jump, review).",
        "author": "Nous & ARES",
        "category": "Companion",
        "status": "available",
        "installed": True,
    ...
    {
        "id": "voice-studio",
        "name": "Voice & Audio Studio",
        "version": "2.0.0",
        "description": "Microphone waveform visualizer, Kokoro & ElevenLabs voice manager, and real-time audio pipeline.",
        "author": "Jaeger OS",
        "category": "Audio",
        "status": "available",
        "installed": False,
    ...
    {
        "id": "kanban-dashboard",
        "name": "Interactive Project Kanban",
        "version": "1.9.0",
        "description": "Visual drag-and-drop board for agile task tracking, session milestone management, and autonomous ticket updates.",
        "author": "ARES Ecosystem",
    ...
    {
        "id": "mcp-inspector",
        "name": "MCP Tool & Resource Inspector",
        "version": "1.4.0",
        "description": "Model Context Protocol live server latency diagnostics, schema inspection, and tool invocation debugger.",
        "author": "Anthropic / ARES",
    ...
    {
        "id": "memory-graph-viewer",
        "name": "Episodic & Semantic Memory Graph",
        "version": "1.6.0",
        "description": "Interactive graph visualization of agent entity relationships, conversation memories, and fact recall.",
        "author": "Jaeger / ARES",
        "category": "Memory",
        "status": "available",
        "installed": True,
    ...
    },
    {
        ...
        "name": "TouchDesigner Realtime Bridge",
        "version": "1.1.0",
        "description": "Live OSC and WebSocket audio-visual generator bridge connecting Jaeger voice streams to TouchDesigner.",
        "author": "Jaeger OS",
        "category": "Creative",
        "status": "available",
        "installed": False,
...
def get_extension_registry() -> Dict[str, Any]:
    """Fetch the extension registry with a 5-minute TTL cache, falling back to curated list."""
    with _REGISTRY_LOCK:
        now = time.monotonic()
        ...
        try:
            opener = _build_gallery_opener()
            raw = opener.open(_REGISTRY_URL, timeout=5).read(2 * 1024 * 1024)
            ...
            if not isinstance(entries, list) or not entries:
                entries = _CURATED_EXTENSION_ENTRIES
            _REGISTRY_CACHE["data"] = entries
            _REGISTRY_CACHE["fetched_at"] = now
            return {"entries": entries}
        except Exception:
            _REGISTRY_CACHE["data"] = _CURATED_EXTENSION_ENTRIES
            _REGISTRY_CACHE["fetched_at"] = now
            return {"entries": _CURATED_EXTENSION_ENTRIES}
