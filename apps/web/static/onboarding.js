...
function _renderOnboardingBody(){
  ...
  if(key==='system'){
    // Backend emits `ares_found` (api/onboarding.py). This read said
    // `hermes_found`, which no endpoint has ever produced, so it was
    // permanently undefined and this check permanently false.
