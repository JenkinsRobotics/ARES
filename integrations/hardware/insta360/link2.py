...
Serves as the primary perception nervous system for ARES:
...
from integrations.hardware.insta360.iokit_uvc import Link2GimbalIOKit
from integrations.hardware.insta360.media_capture import AVFoundationCapture

logger = logging.getLogger("ares.hardware.insta360.link2")
...
class Insta360Link2(BaseCameraAdapter, BaseAudioAdapter, BasePTZController):
    ...
    def status(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"Gimbal status check failed: {exc}")
