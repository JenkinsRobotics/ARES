...
font files for the ARES interface, conversations, and code. It adds a
**Typography** button to the WebUI rail.

## Install for local testing

From a ARES checkout, point the manifest-bundle loader at this entry:
...
Disable Typography by restarting ARES without the extension directory or
