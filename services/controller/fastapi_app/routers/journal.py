...
def journal_stats():
    ...
    from core.memory.journal.schema import stats
    return stats()
...
def journal_search(
    ...
    from core.memory.journal.schema import search
...
def journal_conversations(
    ...
    from core.memory.journal.schema import list_conversations
...
def journal_conversation(conversation_id: int):
    ...
    from core.memory.journal.schema import get_conversation
...
def journal_import(
    ...
    from core.memory.journal.import_all import import_all
...
def journal_volumes():
    ...
    from core.memory.journal.volume_scanner import list_volumes
...
def journal_mount_volume(
    ...
    """Mount an SMB share."""
    from core.memory.journal.volume_scanner import mount_smb
...
def journal_unmount_volume(
    ...
    """Unmount a volume."""
    from core.memory.journal.volume_scanner import unmount
    return unmount(path)
