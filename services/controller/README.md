...
Docker compatibility, upgrade, GPU, and troubleshooting guidance lives in
[`docs/docker.md`](docs/docker.md). WSL startup options are documented in
...
- Docker details: [`docs/docker.md`](docs/docker.md); source/API boundary:
